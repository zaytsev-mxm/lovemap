...
type LovemapHeatmapData = {
    min?: number;
    max?: number;
    data?: HeatMapPoint[];
};

type LovemapHeatmapConfig = {
...
class LovemapHeatmapLayer {
    data: LovemapHeatmapData;
    config: LovemapHeatmapConfig;
    overlay: typeof LeafletHeatmap;
    ...
    constructor(params: LovemapHeatmapParams = {}) {
        ...
        this.config = params.config || LovemapHeatmapLayer.DEFAULTS.CONFIG;
...
export default LovemapHeatmapLayer;